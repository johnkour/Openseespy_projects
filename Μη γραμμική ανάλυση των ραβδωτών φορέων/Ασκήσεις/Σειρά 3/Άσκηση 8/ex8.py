...
P_imp = np.array([0 * kN, imp / L * Pcr,  0 * kN * m])
...
text = '''
How many elements do you require? (For 2, press enter)
'''

Nelems = input(text)

if len(Nelems) == 0:    Nelems = 2
